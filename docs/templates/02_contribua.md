...
Obrigado por se interessar por contribuir no projeto `notas-musicais` ![heart](https://github.githubassets.com/images/icons/emoji/unicode/2764.png). Nesse documento estão listadas as operações mais comuns e que você pode precisar para contribuir.
...
```yaml
extra:  commands:    run: poetry run notas-musicais
```
...
Esse documento pode ser melhorado por qualquer pessoa que tenha interesse em melhora-lo. Então, sinta-se a vontade para fornecer mais dicas as pessoas que desejam contribuir também ![heart](https://github.githubassets.com/images/icons/emoji/unicode/2764.png)
